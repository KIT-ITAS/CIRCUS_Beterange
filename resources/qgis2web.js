...
map.getView().fit([-357916.463291, 5982462.179431, -28898.638068, 6182692.782849], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ground Mounted PV</h2>';
        return titleElement;
    })(),
